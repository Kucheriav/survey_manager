# from flask import Flask, render_template, request, redirect, url_for, config
# from flask_mail import Mail, Message
# import re
#
# app = Flask(__name__)
# app.config.from_pyfile('config.ini', prefix='FLASK')
#
# mail = Mail(app)
#
# users = {}
...
import os
c = read_config(os.path.dirname(os.path.abspath(__file__)), 'flask')
print(c)
